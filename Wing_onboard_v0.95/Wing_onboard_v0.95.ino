...
void setup() {
  ...
  myFile = SD.open("wing_v_0_95.csv", FILE_WRITE);
...
void loop() {
  angle_raw = 1.1f*dtermFiltera.updateEstimate(angle_in.read());
  ...
  pid_out_zip = constrain(pid_out_zip, -pid_maxOut, pid_maxOut);
